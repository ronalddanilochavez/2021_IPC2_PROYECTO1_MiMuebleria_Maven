...
<html>
    ...
    <body>
        ...
        <div class="departamento">
            ...
            <form action="" method="post" autocomplete="on">
                <label for="ventas_muebles_disponibles">Muebles disponibles </label>
                
                <!-- Llenar los valores con los muebles -->
                    <select id="ventas_mueble_elegir" name="ventas_mueble_elegir" size="1">
                        <% 
                ...
                <input type="date" id="ventas_fechaventa" name="ventas_fechaventa" value="">
                <br><br>  
                <label for="ventas_mueble_ID">ID del mueble </label>
                <input type="text" id="ventas_mueble_ID" name="ventas_mueble_ID" value="" required>
                <br><br>
        ...
        <div class="departamento">
            ...
            <form action="" method="post" autocomplete="on">
                ...
                <select id="ventas_devolucion_muebles" name="ventas_devolucion_muebles" size="1">
                    <% 
                ...
                <br><br>
                <label for="ventas_mueble_ID">ID del mueble </label>
                <input type="text" id="ventas_devolucion_muebleID" name="ventas_devolucion_muebleID" value="" required>
                <br><br>
        ...
        <div class="departamento">
            ...
            <h1>Consultas de compras de un cliente</h1>
            ...
            <form action="" method="post" autocomplete="on">
                ...
                <br><br>
                <label for="fname"> NIT Cliente </label>
                <input type="text" id="ventas_consultaventas_NITCliente" name="ventas_consultaventas_NITCliente" value="" required>
        ...
        <div class="departamento">
            ...
            <form action="" method="post" autocomplete="on">
                <input type="submit" value="Consultar de ventas del dia">
                <br><br>
                <!-- Llenar con datos -->
                    <table style="width:100%" id="ventas_tabla_consultaventas">
                        <tr>
        ...
        <div class="departamento">
            ...
            <form action="" method="post" autocomplete="on">
                ...
                <br><br>
                <label for="fname"> Fecha inicial </label>
                <input type="text" id="ventas_consultadevoluciones_NITCliente" name="ventas_consultadevoluciones_NITCliente" value="">
                <label for="fname"> Fecha inicial </label>
