            ...
            <form action="administracion_formulario_consultaUsuarioMasVentas_intervaloTiempo.jsp" method="post" autocomplete="on">
                ...
                <!-- Llenar con datos -->
                    <table style="width:100%" id="administracion_tabla_consultausuarioventas">
                        ...
                        <% 
                            String fechaInicial = request.getParameter("administracion_consultausuarioventasCSV_fechainicial");
                            String fechaFinal = request.getParameter("administracion_consultausuarioventasCSV_fechafinal");
                            String administracionConsultaUsuarioMasVentas = mainClass.administracionConsultaUsuarioMasVentas(fechaInicial, fechaFinal,true);
