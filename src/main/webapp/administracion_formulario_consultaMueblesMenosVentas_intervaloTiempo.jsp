    ...
    <body>
        ...
        <div class="departamento">
            ...
            <form action="administracion_formulario_consultaMueblesMenosVentas_intervaloTiempo.jsp" method="post" autocomplete="on">
                ...
                <!-- Llenar con datos -->
                    <table style="width:100%" id="administracion_tabla_consultamueblemenosventas">
                        ...
                        <% 
                            String fechaInicial = request.getParameter("administracion_consultamueblemenosventas_fechainicial");
                            String fechaFinal = request.getParameter("administracion_consultamueblemenosventas_fechafinal");
                            String administracionConsultaMuebleMenosVentas = mainClass.administracionConsultaMuebleMenosVentas(fechaInicial, fechaFinal,false);
                            
                            out.print(administracionConsultaMuebleMenosVentas);
                        %>
                        <!--
                        <tr>
                            <td>ALSDHLAKJHSD</td>
            ...
            <form action="administracion_formulario_consultaMueblesMenosVentas_intervaloTiempo_CSV.jsp" method="post" autocomplete="on">
                ...
                <input type="date" id="administracion_consultamueblemenosventasCSV_fechainicial" name="administracion_consultamueblemenosventasCSV_fechainicial" value="<% out.print(fechaInicial);%>" readonly="" hidden="">
                <label for="fname" hidden=""> Fecha final </label>
                <input type="date" id="administracion_consultamueblemenosventasCSV_fechafinal" name="administracion_consultamueblemenosventasCSV_fechafinal" value="<% out.print(fechaFinal);%>" readonly="" hidden="">
                <input type="submit" id="administracion_consultamueblemenosventasCSV_exportar" name="administracion_consultamueblemenosventas_exportar" value="Exportar archivo CSV">
                <br><br>
            </form>
