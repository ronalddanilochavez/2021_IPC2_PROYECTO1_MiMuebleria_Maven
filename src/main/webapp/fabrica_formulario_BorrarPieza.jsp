...
<html>
    ...
    <body>
        ...
        <div class="departamento">
            ...
            <%
                String piezaTipo = request.getParameter("fabrica_borrarpieza_tipo");
                String fabricaBorrarPieza = mainClass.fabricaBorrarPieza(piezaTipo);

                out.print(fabricaBorrarPieza);
            %>
            <!--
                <h2>Pieza borrada</h2>
                <h2>Tipo: </h2>
