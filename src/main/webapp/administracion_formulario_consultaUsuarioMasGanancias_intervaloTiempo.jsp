    ...
    <body>
        ...
        <div class="departamento">
            ...
            <form action="administracion_formulario_consultaUsuarioMasGanancias_intervaloTiempo.jsp" method="post" autocomplete="on">
                ...
                <!-- Llenar con datos -->
                    <table style="width:100%" id="administracion_tabla_consultausuarioganacias">
                        ...
                        <% 
                            String fechaInicial = request.getParameter("administracion_consultausuarioganancias_fechainicial");
                            String fechaFinal = request.getParameter("administracion_consultausuarioganancias_fechafinal");
                            String administracionConsultaUsuarioMasGanancias = mainClass.administracionConsultaUsuarioMasGanancias(fechaInicial, fechaFinal,false);
                            
                            out.print(administracionConsultaUsuarioMasGanancias);
                        %>
                        <!--
                        <tr>
                            <td>ALSDHLAKJHSD</td>
            ...
            <form action="administracion_formulario_consultaUsuarioMasGanancias_intervaloTiempo_CSV.jsp" method="post" autocomplete="on">
                ...
                <input type="date" id="administracion_consultausuariogananciasCSV_fechainicial" name="administracion_consultausuariogananciasCSV_fechainicial" value="<% out.print(fechaInicial);%>" readonly="" hidden="">
                <label for="fname" hidden=""> Fecha final </label>
                <input type="date" id="administracion_consultausuariogananciasCSV_fechafinal" name="administracion_consultausuariogananciasCSV_fechafinal" value="<% out.print(fechaFinal);%>" readonly="" hidden="">
                <input type="submit" id="administracion_consultausuariogananciasCSV_exportar" name="administracion_consultausuariogananciasCSV_exportar" value="Exportar archivo CSV">
                <br><br>
            </form>
