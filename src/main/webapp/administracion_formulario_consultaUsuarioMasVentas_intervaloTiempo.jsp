    ...
    <body>
        ...
        <div class="departamento">
            ...
            <form action="administracion_formulario_consultaUsuarioMasVentas_intervaloTiempo.jsp" method="post" autocomplete="on">
                ...
                <!-- Llenar con datos -->
                    <table style="width:100%" id="administracion_tabla_consultausuarioventas">
                        ...
                        <% 
                            String fechaInicial = request.getParameter("administracion_consultausuarioventas_fechainicial");
                            String fechaFinal = request.getParameter("administracion_consultausuarioventas_fechafinal");
                            String administracionConsultaUsuarioMasVentas = mainClass.administracionConsultaUsuarioMasVentas(fechaInicial, fechaFinal,false);
                            
                            out.print(administracionConsultaUsuarioMasVentas);
                        %>
                        <!--
                        <tr>
                            <td>ALSDHLAKJHSD</td>
            ...
            <form action="administracion_formulario_consultaUsuarioMasVentas_intervaloTiempo_CSV.jsp" method="post" autocomplete="on">
                ...
                <input type="date" id="administracion_consultausuarioventasCSV_fechainicial" name="administracion_consultausuarioventasCSV_fechainicial" value="<% out.print(fechaInicial);%>" readonly="" hidden="">
                <label for="fname" hidden=""> Fecha final </label>
                <input type="date" id="administracion_consultausuarioventasCSV_fechafinal" name="administracion_consultausuarioventasCSV_fechafinal" value="<% out.print(fechaFinal);%>" readonly="" hidden="">
                <input type="submit" id="administracion_consultausuarioventasCSV_exportar" name="administracion_consultausuarioventas_exportar" value="Exportar archivo CSV">
                <br><br>
            </form>
