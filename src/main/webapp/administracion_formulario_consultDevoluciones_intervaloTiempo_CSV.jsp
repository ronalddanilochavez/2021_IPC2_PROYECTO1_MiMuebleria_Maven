            ...
            <form action="administracion_formulario_consultDevoluciones_intervaloTiempo.jsp" method="post" autocomplete="on">
                ...
                <!-- Llenar con datos -->
                    <table style="width:100%" id="administracion_tabla_consultadevoluciones">
                        ...
                        <% 
                            String fechaInicial = request.getParameter("administracion_consultadevolucionesCSV_fechainicial");
                            String fechaFinal = request.getParameter("administracion_consultadevolucionesCSV_fechafinal");
                            String administracionConsultaDevoluciones = mainClass.administracionConsultaDevoluciones(fechaInicial, fechaFinal,true);
