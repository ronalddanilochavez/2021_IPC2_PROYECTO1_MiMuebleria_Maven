            ...
            <form action="administracion_formulario_consultaMueblesMenosVentas_intervaloTiempo.jsp" method="post" autocomplete="on">
                ...
                <!-- Llenar con datos -->
                    <table style="width:100%" id="administracion_tabla_consultamueblemenosventas">
                        ...
                        <% 
                            String fechaInicial = request.getParameter("administracion_consultamueblemenosventasCSV_fechainicial");
                            String fechaFinal = request.getParameter("administracion_consultamueblemenosventasCSV_fechafinal");
                            String administracionConsultaMuebleMenosVentas = mainClass.administracionConsultaMuebleMenosVentas(fechaInicial, fechaFinal,true);
