    ...
    <body>
        ...
        <div class="departamento">
            ...
            <form action="administracion_formulario_borrarUsuario.jsp" method="post" autocomplete="on">
                ...
                <br><br>
                <% 
                    String usuarioNombre = request.getParameter("administracion_usuarios_borrar");
                    String administracionBorrarUsuario = mainClass.administracionBorrarUsuario(usuarioNombre);
                    
                    out.print(administracionBorrarUsuario);
                %>
                <br><br>
            </form>
