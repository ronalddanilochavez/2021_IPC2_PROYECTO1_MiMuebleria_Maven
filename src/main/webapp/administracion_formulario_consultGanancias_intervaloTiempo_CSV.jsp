            ...
            <form action="administracion_formulario_consultGanancias_intervaloTiempo.jsp" method="post" autocomplete="on">
                ...
                <!-- Llenar con datos -->
                    <table style="width:100%" id="administracion_tabla_consultaganacias">
                        ...
                        <% 
                            String fechaInicial = request.getParameter("administracion_consultagananciasCSV_fechainicial");
                            String fechaFinal = request.getParameter("administracion_consultagananciasCSV_fechafinal");
                            String administracionConsultaGanancias = mainClass.administracionConsultaGanancias(fechaInicial, fechaFinal,true);
