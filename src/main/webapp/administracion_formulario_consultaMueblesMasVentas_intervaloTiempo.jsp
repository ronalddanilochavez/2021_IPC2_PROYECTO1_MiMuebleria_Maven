            ...
            <form action="administracion_formulario_consultaMueblesMasVentas_intervaloTiempo.jsp" method="post" autocomplete="on">
                ...
                <!-- Llenar con datos -->
                    <table style="width:100%" id="administracion_tabla_consultamuebleventas">
                        ...
                        <% 
                            String fechaInicial = request.getParameter("administracion_consultamuebleventas_fechainicial");
                            String fechaFinal = request.getParameter("administracion_consultamuebleventas_fechafinal");
                            String administracionConsultaMuebleMasVentas = mainClass.administracionConsultaMuebleMasVentas(fechaInicial, fechaFinal,false);
