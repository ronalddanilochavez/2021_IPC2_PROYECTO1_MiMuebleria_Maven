    ...
    <body>
        ...
        <div class="departamento">
            ...
            <form action="administracion_formulario_consultGanancias_intervaloTiempo.jsp" method="post" autocomplete="on">
                ...
                <!-- Llenar con datos -->
                    <table style="width:100%" id="administracion_tabla_consultaganacias">
                        ...
                        <% 
                            String fechaInicial = request.getParameter("administracion_consultaganancias_fechainicial");
                            String fechaFinal = request.getParameter("administracion_consultaganancias_fechafinal");
                            String administracionConsultaGanancias = mainClass.administracionConsultaGanancias(fechaInicial, fechaFinal,false);
                            
                            out.print(administracionConsultaGanancias);
                        %>
                        <!--
                        <tr>
                            <td>ALSDHLAKJHSD</td>
            ...
            <form action="administracion_formulario_consultGanancias_intervaloTiempo_CSV.jsp" method="post" autocomplete="on">
                ...
                <input type="date" id="administracion_consultagananciasCSV_fechainicial" name="administracion_consultagananciasCSV_fechainicial" value="<% out.print(fechaInicial);%>" readonly="" hidden="">
                <label for="fname" hidden=""> Fecha final </label>
                <input type="date" id="administracion_consultagananciasCSV_fechafinal" name="administracion_consultagananciasCSV_fechafinal" value="<% out.print(fechaFinal);%>" readonly="" hidden="">
                <input type="submit" id="administracion_consultagananciasCSV_exportar" name="administracion_consultaganancias_exportar" value="Exportar archivo CSV">
                <br><br>
            </form>
