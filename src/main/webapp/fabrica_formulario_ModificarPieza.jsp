    ...
    <body>
        ...
        <div class="departamento">
            ...
            <form action="fabrica_formulario_ModificarPieza.jsp" method="post" autocomplete="on">
                ...
                <br><br>
                <%
                    String piezaTipo = request.getParameter("fabrica_modificarpieza_tipo");
                    String piezaCosto = request.getParameter("fabrica_modificarpieza_costo");
                    String piezaCantidad = request.getParameter("fabrica_modificarpieza_cantidad");
                    String fabricaModificarPieza = mainClass.fabricaModificarPieza(piezaTipo,piezaCosto,piezaCantidad);
                    
                    out.print(fabricaModificarPieza);
                %>
                <!--
