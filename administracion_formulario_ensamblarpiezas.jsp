...
<html>
    ...
    <body>
        ...
        <div class="departamento">
            ...
            <form action="administracion_formulario_consultVentas_intervaloTiempo" method="post" autocomplete="on">
            ...
            <form action="administracion_formulario_consultVentas_intervaloTiempo_CSV" method="post" autocomplete="on">
        ...
        <div class="departamento">
            ...
            <form action="administracion_formulario_consultDevoluciones_intervaloTiempo" method="post" autocomplete="on">
                <label for="fname"> Fecha inicial </label>
            ...
            <form action="administracion_formulario_consultDevoluciones_intervaloTiempo_CSV" method="post" autocomplete="on">
        ...
        <!-- /////////////////////////////////////////////////////-->
        <!-- Consulta de ganancias en un intervalo de tiempo -->
        <!-- /////////////////////////////////////////////////////-->
        
        <div class="departamento">
            
            <h1>Consulta de ganancias en un intervalo de tiempo</h1>
            
            <form action="administracion_formulario_consultGanancias_intervaloTiempo" method="post" autocomplete="on">
                <label for="fname"> Fecha inicial </label>
            ...
            <form action="administracion_formulario_consultGanancias_intervaloTiempo_CSV" method="post" autocomplete="on">
        ...
        <div class="departamento">
            ...
            <form action="administracion_formulario_consultaUsuarioMasVentas_intervaloTiempo" method="post" autocomplete="on">
                <label for="fname"> Fecha inicial </label>
            ...
            <form action="administracion_formulario_consultaUsuarioMasVentas_intervaloTiempo_CSV" method="post" autocomplete="on">
        ...
        <div class="departamento">
            ...
            <form action="administracion_formulario_consultaUsuarioMasGanancias_intervaloTiempo" method="post" autocomplete="on">
                <label for="fname"> Fecha inicial </label>
            ...
            <form action="administracion_formulario_consultaUsuarioMasGanancias_intervaloTiempo_CSV" method="post" autocomplete="on">
        ...
        <div class="departamento">
            ...
            <form action="administracion_formulario_consultaMueblesMasVentas_intervaloTiempo" method="post" autocomplete="on">
                <label for="fname"> Fecha inicial </label>
            ...
            <form action="administracion_formulario_consultaMueblesMasVentas_intervaloTiempo_CSV" method="post" autocomplete="on">
        ...
        <div class="departamento">
            ...
            <form action="administracion_formulario_consultaMueblesMenosVentas_intervaloTiempo" method="post" autocomplete="on">
                <label for="fname"> Fecha inicial </label>
            ...
            <form action="administracion_formulario_consultaMueblesMenosVentas_intervaloTiempo_CSV" method="post" autocomplete="on">
        ...
        <div class="departamento">
            ...
            <form action="administracion_formulario_ensamblarpiezas" method="post" autocomplete="on">
                ...
                <br><br>
                <label for="administracion_piezas_disponibles">Piezas disponibles </label> 
                <!-- Llenar los valores con las piezas -->
                    <select id="administracion_piezas_elegir" name="administracion_piezas_elegir" size="1">
                        <% 
                ...
                <!-- Llenar los valores con las piezas -->
                <br><br>
                <label for="administracion_ensamblarpiezas_pieza">Pieza </label>
                <input type="text" id="administracion_ensamblarpiezas_pieza" name="administracion_ensamblarpiezas_pieza" value="" required>
                <br><br>
                ...
                <%
                    ...
                    String fabricaDefinirEnsamblePiezas = mainClass.definirEnsamblePiezas(muebleNombre, mueblePieza, muebleCantidad);
        ...
        <div class="departamento">
            ...
            <form action="administracion_formulario_crearUsuario" method="post" autocomplete="on">
            ...
            <form action="administracion_formulario_bloquearUsuario" method="post" autocomplete="on">
                <label for="administracion_usuarios_disponibles">Usuarios disponibles </label> 
                <!-- Llenar los valores con las usuarios -->
                    <select id="administracion_piezas_elegir" name="administracion_usuarios_elegir" size="1">
                        <% 
                ...
                <br><br>
                <label for="fname">Usuario </label>
                <input type="text" id="administracion_usuario_bloquear" name="administracion_usuario_bloquear" value="" required>
                <br><br>
            ...
            <form action="administracion_formulario_borrarUsuario" method="post" autocomplete="on">
                <label for="administracion_usuarios_disponibles">Usuarios disponibles </label> 
                <!-- Llenar los valores con las usuarios -->
                    <select id="administracion_piezas_elegir" name="administracion_usuarios_elegir" size="1">
                        <% 
                ...
                <br><br>
                <label for="fname">Usuario </label>
                <input type="text" id="administracion_usuario_borrar" name="administracion_usuario_borrar" value="" required>
                <br><br>
        ...
        <div class="departamento">
            ...
            <form action="administracion_formulario_importarArchivo" method="post" autocomplete="on">
