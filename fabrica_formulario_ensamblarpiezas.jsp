...
<html>
    ...
    <body>
        ...
        <!-- /////////////////////////////////////////////////////-->
        <!-- Ensamblar mueble a partir de piezas -->
        <!-- /////////////////////////////////////////////////////-->
        ...
        <div class="departamento">
            ...
            <form action="fabrica_formulario_ensamblarMueble.jsp" method="post" autocomplete="on">
                ...
                <%
                    String muebleNombre = request.getParameter("fabrica_ensamblarpiezas_nombremueble");
                    String mueblePieza = request.getParameter("fabrica_ensamblarpiezas_pieza");
                    String muebleCantidad = request.getParameter("fabrica_ensamblarpiezas_cantidad");
