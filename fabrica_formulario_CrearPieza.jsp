    ...
    <body>
        ...
        <div class="departamento">
            ...
            <form action="fabrica_formulario_CrearPieza.jsp" method="post" autocomplete="on">
                ...
                <input type="text" id="fabrica_crearpieza_tipo" name="fabrica_crearpieza_tipo" value="" required>
                <br><br>
                <label for="fname">Cantidad de piezas </label>
                <input type="text" id="fabrica_crearpieza_cantidad" name="fabrica_crearpieza_cantidad" value="" required>
                <br><br>
                <label for="fname">Costo de pieza </label>
                <input type="text" id="fabrica_crearpieza_costo" name="fabrica_crearpieza_costo" value="" required>
                <br><br>
                <input type="submit" value="Crear pieza">
                <br><br>
                <%
                    String piezaTipo = request.getParameter("fabrica_crearpieza_tipo");
                    String piezaCosto = request.getParameter("fabrica_crearpieza_costo");
                    String piezaCantidad = request.getParameter("fabrica_crearpieza_cantidad");
                    String fabricaCrearPieza = mainClass.fabricaCrearPieza(piezaTipo,piezaCosto,piezaCantidad);
                    
                    out.print(fabricaCrearPieza);
                %>
                <!--
                    <h2>Pieza creada</h2>
                    <h2>Tipo: </h2>
            ...
            <form action="fabrica_formulario_ModificarPieza.jsp" method="post" autocomplete="on">
                ...
                <br><br>
                <label for="fname">Tipo de pieza </label>
                <input type="text" id="fabrica_modificarpieza_tipo" name="fabrica_modificarpieza_tipo" value="" required>
                <br><br>
                <label for="fname">Cantidad de piezas </label>
                <input type="text" id="fabrica_modificarpieza_cantidad" name="fabrica_modificarpieza_cantidad" value="" required>
                <br><br>
                <label for="fname">Costo de pieza </label>
                <input type="text" id="fabrica_modificarpieza_costo" name="fabrica_modificarpieza_costo" value="" required>
                <br><br>
            ...
            <form action="fabrica_formulario_BorrarPieza.jsp" method="post" autocomplete="on">
                <label for="fname">Tipo de pieza </label>
                <input type="text" id="fabrica_borrarpieza_tipo" name="fabrica_borrarpieza_tipo" value="" required>
                <br><br>
        ...
        <div class="departamento">
            ...
            <form action="fabrica_formulario_ensamblarMueble.jsp" method="post" autocomplete="on">
                ...
                <input type="text" id="fabrica_ensamblarpiezas_nombremueble" name="fabrica_ensamblarpiezas_nombremueble" value="" required>
                <br><br>
                ...
                <input type="text" id="fabrica_ensamblarpiezas_pieza" name="fabrica_ensamblarpiezas_pieza" value="" required>
                <br><br>
                <label for="fabrica_ensamblarpiezas_cantidad">Cantidad </label>
                <input type="text" pattern="[0-9]" id="fabrica_ensamblarpiezas_cantidad" name="fabrica_ensamblarpiezas_cantidad" value="" required>
                <br><br>
                <input type="submit" id="fabrica_ensamblarmueble_agregarpieza" name="fabrica_ensamblarmueble_agregarpieza" value="Agregar pieza">
            ...
            <form action="fabrica_formulario.jsp" method="post" autocomplete="on">
                <input type="submit" id="fabrica_ensamblarmueble_resetear" name="fabrica_ensamblarmueble_resetear" value="Resetear">
                <br><br>
            </form>
